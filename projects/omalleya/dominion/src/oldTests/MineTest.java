...
public class MineTest {
    ...
    public void test0()  throws Throwable  {   
        ...
        System.out.println("hand count = " + state.players.get(0).hand.size() + ", expected = "+ ( testState.players.get(0).hand.size() - 4 ) );       
        System.out.println("deck count = " + state.players.get(0).discarded.size() + ", expected = "+ ( testState.players.get(0).discarded.size() + 2 ) );       
        System.out.println("numActions = " + state.players.get(0).numActions + ", expected = "+ ( testState.players.get(0).numActions - 2 ) );
        System.out.println("coins = " + state.players.get(0).coins + ", expected = "+ ( testState.players.get(0).coins ) );
        ...
        assertEquals(state.players.get(0).hand.size(), ( testState.players.get(0).hand.size() - 4));       
        assertEquals(state.players.get(0).deck.size(), ( testState.players.get(0).deck.size() ));
        assertEquals(state.players.get(0).discarded.size(), ( testState.players.get(0).discarded.size() + 2 ));
        assertEquals(state.players.get(0).coins, ( testState.players.get(0).coins ));
        assertEquals(state.players.get(0).numBuys, ( testState.players.get(0).numBuys ));
        assertEquals(state.players.get(0).playedCards.size(), ( testState.players.get(0).playedCards.size() + 2 ));
