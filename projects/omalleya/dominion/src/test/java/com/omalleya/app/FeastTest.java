...
public class FeastTest {
    ...
    public void test0()  throws Throwable  {   
        ...
        assertEquals(state.players.get(0).discarded.size(), ( testState.players.get(0).discarded.size() + 1 ));
        ...
        assertEquals(state.players.get(0).playedCards, ( testState.players.get(0).playedCards ));
