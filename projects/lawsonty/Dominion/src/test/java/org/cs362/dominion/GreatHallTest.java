...
public class GreatHallTest extends TestCase {
	public void test(){
		...
		game.start();
		p2.hand.add(Card.GREAT_HALL);
		p2.play(Card.GREAT_HALL);
		
		assertEquals(1, p2.actions());
		assertEquals(6, p2.hand.size());
		assertEquals(4, game.countVictory(p2));
	}
}
