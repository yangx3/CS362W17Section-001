...
public class CardTest {
    ...
    public void testGetCard() {
        Card c = Card.getCard(cards, Card.Name.COPPER);
        assertEquals(c.getName(), Card.Name.COPPER);
    }

    @Test
    public void testGetCardBoard() {
        Card c = Card.getCardBoard(g.board, Card.Name.COPPER);
        assertEquals(c.getName(), Card.Name.COPPER);
    }

    @Test
    public void testFilter() {
        List<Card> set = Card.filter(cards, Card.Type.TREASURE);
        for (Card c : set)
            assertEquals(c.getType(), Card.Type.TREASURE);
    }
}