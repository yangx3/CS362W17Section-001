	...
	public void play(Player player, GameState state) {
		...
		switch(this.cardName) {
            ...
            case Cutpurse:
                ...
                player.coins += 2;
                Card hC = getCard(state.cards,CardName.Cooper);
            ...
            case Embargo:
                System.out.println("\n[EMBARGO]");
                System.out.println("- Trash this card, putting an Embargo token on a stack in the supply.");
