...
public class Council_RoomTest {
	  ...
	  public void test()  throws Throwable  {	   
		 ...
		 // initialize a game state and player cards
		    ...
		    System.out.println("deck count = " + state.players.get(1).deck.size() + ", expected = "+ ( testState.players.get(1).deck.size() - 4 ) );
		    ...
		    assertEquals(state.players.get(1).deck.size(),( testState.players.get(1).deck.size() - 4));
	   }
}
