...
//			
		      ...
		      System.out.println("hand count = " + state.players.get(1).hand.size() + ", expected = "+ ( testState.players.get(1).hand.size() + newCardsp2  ) );
		      System.out.println("deck count = " + state.players.get(1).deck.size() + ", expected = "+ ( testState.players.get(1).deck.size() - newCardsp2  ) );
		      ...
		      assertEquals(state.players.get(1).hand.size(),( testState.players.get(1).hand.size() + newCardsp2))      ;
		      assertEquals(state.players.get(1).deck.size(),( testState.players.get(1).deck.size() - newCardsp2 ))      ;
