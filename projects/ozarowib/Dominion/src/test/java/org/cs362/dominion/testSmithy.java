...
public class testSmithy
{
	@Test
	// Tests playing a Smithy card
	public void test() throws Throwable {
		...
		for (Player player : state.players)
		{
			...
			c.play(player, state);
			// Check that hand goes up by three and deck goes down same
			assertEquals( player.hand.size(), startstate.players.get(i).hand.size()+3 );
