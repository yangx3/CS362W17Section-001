...
public class testBaron
{
	...
	public void test() throws Throwable {
		...
		for (Player player : state.players)
		{
			...
			// If hand size is less than original-1 another card was lost in addition to the Baron being played
			// Should mean an Estate is now in the discard pile
			if (player.hand.size() < startstate.players.get(i).hand.size()-1)
			{
				// If Estate was discarded player coin should be increased
