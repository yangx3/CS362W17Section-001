...
public class GameState_ESTest extends GameState_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      GameState gameState0 = new GameState((-38), (-38), false);
      Scanner scanner0 = gameState0.scan;
      gameState0.supply = null;
      gameState0.newTurn();
      // Undeclared exception!
      try { 
        gameState0.getEmbargo(9);
  ...
  public void test01()  throws Throwable  {
      ...
      arrayList0.add((GameState.Supply) null);
  ...
  public void test02()  throws Throwable  {
      ...
      try { 
        ...
        fail("Expecting exception: NullPointerException");
         ...
         // no message in exception (getMessage() returned null)
         //
         verifyException("org.cs362.dominion.Dominion.GameState$Supply", e);
      }
  }

  @Test(timeout = 4000)
  public void test03()  throws Throwable  {
      GameState gameState0 = new GameState(0, (-747), false);
      // Undeclared exception!
      gameState0.newTurn();
  }
  ...
  public void test11()  throws Throwable  {
      GameState gameState0 = new GameState((-3828), (-3828), true);
      Card card0 = Card.SILVER;
      gameState0.addTrash(card0);
      ...
      ArrayList<GameState.Supply> arrayList0 = new ArrayList<GameState.Supply>();
      gameState0.supply = arrayList0;
      arrayList0.removeAll(gameState0.supply);
      gameState0.findWinner();
      arrayList0.sort((Comparator<? super GameState.Supply>) null);
      // Undeclared exception!
      try { 
        gameState0.getFaceCard(0);
        fail("Expecting exception: IndexOutOfBoundsException");
  ...
  public void test18()  throws Throwable  {
      GameState gameState0 = new GameState((-2733), (-1), false);
      gameState0.newTurn();
      gameState0.printBoard();
      gameState0.loud = true;
      ArrayList<GameState.Supply> arrayList0 = gameState0.supply;
  ...
  public void test20()  throws Throwable  {
      GameState gameState0 = new GameState((-88), (-88), false);
      gameState0.printBoard();
  }
  ...
  public void test29()  throws Throwable  {
      ...
      GameState gameState0 = new GameState((-423), (-423), false);
      gameState0.getEmbargo(10);
      SystemInUtil.addInputLine("");
      gameState0.getTrashSize();
  }
  ...
  public void test31()  throws Throwable  {
      GameState gameState0 = new GameState((-873), (-873), true);
      gameState0.getTrashSize();
      Card card0 = Card.CUTPURSE;
      FileSystemHandling.appendStringToFile((EvoSuiteFile) null, "*%U~P[z;=5@nSu?4@");
      gameState0.setEmbargo(0);
      gameState0.removeSupply(card0);
      ArrayList<GameState.Supply> arrayList0 = new ArrayList<GameState.Supply>();
      gameState0.newTurn();
      ...
      try { 
        ...
        fail("Expecting exception: IllegalArgumentException");
         ...
         //
         // Malformed escape pair at index 38: --------------------------------------%n
         //
  ...
  public void test32()  throws Throwable  {
      GameState gameState0 = new GameState(2, 0, false);
      Card card0 = Card.TREASUREMAP;
      gameState0.addTrash(card0);
      gameState0.gameEnd();
      gameState0.loud = true;
      ...
      GameState gameState1 = null;
      try {
        gameState1 = new GameState(2, 0, true);
        fail("Expecting exception: NoSuchElementException");
  ...
  public void test33()  throws Throwable  {
      ...
      gameState0.gameEnd();
      gameState0.addSupply(0);
      ArrayList<GameState.Supply> arrayList1 = gameState0.supply;
  }
  ...
  public void test34()  throws Throwable  {
      int int0 = 0;
      int int1 = (-375);
      GameState gameState0 = new GameState(0, (-375), false);
      Card card0 = Card.SILVER;
      Card card1 = Card.CUTPURSE;
      gameState0.removeSupply(card1);
      gameState0.removeSupply(card0);
      Card card2 = Card.VILLAGE;
      gameState0.addSupply(card2);
      gameState0.gameEnd();
      gameState0.newTurn();
      // Undeclared exception!
      try { 
        gameState0.setEmbargo((-375));
        fail("Expecting exception: ArrayIndexOutOfBoundsException");
