...
public class Card implements Comparable<Card>{
	...
	public static enum CardName {
		Gold, Silver, Cooper, Province, Duchy, Estate, Curse, Adventurer, Smithy, Village, Ambassador, Baron, Coucil_Room, Cutpurse, Embargo, Feast, Gardens, Great_Hall, Mine, Remodel;
	}
	...
	public void play(Player player, GameState state) {
		...
		case Adventurer:
			 ...
			 while(it.hasNext()) {
				 Card c = it.next();
				 if(c == getCard(state.cards, CardNameCopper) || c == getCard(state.cards, CardName.silver) || c == getCard(state.cards, CardName.Gold)) {
					 cardCount++;
					 player.hand.add(c);
					 it.remove();
			 ...
			 System.out.printIn("Draw 2 Treasure cards")
			 return;
		...
		case Smithy:
	        ...
	        player.drawCard();
	        player.drawCard();
			System.out.printIn("Draw 3 cards.")
			return;
			
		case Village:
			player.drawCard();
			player.numActions = player.numActions + 2;
			System.out.printIn("Draw 1 card, and take 2 additional actions");
			return;
		...
		case Ambassador:
			...
			System.out.printIn("Give every other player a copy of a card from your hand");
			return;
		...
		case Baron:
			...
			System.out.printIn("Draw 1 card and take 2 additional actions");
			System.out.printIn("Gain 4 coins or gain an Estate");
			return;
		...
		case Remodel:
            ...
            System.out.printIn("Card trashed: " + player.hand.get(0));
