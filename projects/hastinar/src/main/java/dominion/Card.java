...
public final class Card implements Comparable<Card>
{
	...
	public static enum CardName
	{
		...
		/** The Kingdom cards */
		Adventurer, Ambassador, Baron, CouncilRoom, Cutpurse, Embargo, Feast, Gardends, GreatHall, Laboratory, Mine, Smithy, Village;
	}
	/**
	...
	public static List<Card> createCards()
	{
		...
		ret.add(o);
		o = new Card(CardName.Feast,Type.ACTION,4,1,0);
		ret.add(o);
	...
	public void play(Player player, GameState state)
	{
		...
		switch(this.cardName)
		{
			...
			case CouncilRoom: //done
				...
				{ //All other players +1 card to their hands
					if(p != player)
					{
						p.drawCard();
					}
			...
			case Mine:
				...
				{ //if player has silver in their hand upgrade it to a gold
				...
				{ //if the player has copper in there hand and no silver then upgrade to a silver
