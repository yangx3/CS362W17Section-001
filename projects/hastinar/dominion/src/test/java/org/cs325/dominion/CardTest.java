...
public class CardTest {
    ...
    {
        assertEquals(Card.CardName.Gold, cList.get(0).getCardName());
        assertEquals(Card.Type.TREASURE, cList.get(0).getType());
    ...
    {
        assertEquals(Card.CardName.Silver, cList.get(1).getCardName());
        assertEquals(Card.Type.TREASURE, cList.get(1).getType());
    ...
    {
        assertEquals(Card.CardName.Copper, cList.get(2).getCardName());
        assertEquals(Card.Type.TREASURE, cList.get(2).getType());
    ...
    {
        assertEquals(Card.CardName.Province, cList.get(3).getCardName());
        assertEquals(Card.Type.VICTORY, cList.get(3).getType());
    ...
    {
        assertEquals(Card.CardName.Duchy, cList.get(4).getCardName());
        assertEquals(Card.Type.VICTORY, cList.get(4).getType());
    ...
    {
        assertEquals(Card.CardName.Estate, cList.get(5).getCardName());
        assertEquals(Card.Type.VICTORY, cList.get(5).getType());
    ...
    {
        assertEquals(Card.CardName.Curse, cList.get(6).getCardName());
        assertEquals(Card.Type.VICTORY, cList.get(6).getType());
    ...
    {
        assertEquals(Card.CardName.Adventurer, cList.get(7).getCardName());
        assertEquals(Card.Type.ACTION, cList.get(7).getType());
    ...
    {
        assertEquals(Card.CardName.Ambassador, cList.get(8).getCardName());
        assertEquals(Card.Type.ACTION, cList.get(8).getType());
    ...
    {
        assertEquals(Card.CardName.Baron, cList.get(9).getCardName());
        assertEquals(Card.Type.ACTION, cList.get(9).getType());
    ...
    {
        assertEquals(Card.CardName.CouncilRoom, cList.get(10).getCardName());
        assertEquals(Card.Type.ACTION, cList.get(10).getType());
    ...
    {
        assertEquals(Card.CardName.Cutpurse, cList.get(11).getCardName());
        assertEquals(Card.Type.ACTION, cList.get(11).getType());
    ...
    {
        assertEquals(Card.CardName.Embargo, cList.get(12).getCardName());
        assertEquals(Card.Type.ACTION, cList.get(12).getType());
    ...
    {
        assertEquals(Card.CardName.Feast, cList.get(13).getCardName());
        assertEquals(Card.Type.ACTION, cList.get(13).getType());
    ...
    {
        assertEquals(Card.CardName.Gardends, cList.get(14).getCardName());
        assertEquals(Card.Type.ACTION, cList.get(14).getType());
    ...
    {
        assertEquals(Card.CardName.GreatHall, cList.get(15).getCardName());
        assertEquals(Card.Type.ACTION, cList.get(15).getType());
    ...
    {
        assertEquals(Card.CardName.Laboratory, cList.get(16).getCardName());
        assertEquals(Card.Type.ACTION, cList.get(16).getType());
    ...
    {
        assertEquals(Card.CardName.Mine, cList.get(17).getCardName());
        assertEquals(Card.Type.ACTION, cList.get(17).getType());
    ...
    {
        assertEquals(Card.CardName.Smithy, cList.get(18).getCardName());
        assertEquals(Card.Type.ACTION, cList.get(18).getType());
    ...
    {
        assertEquals(Card.CardName.Village, cList.get(19).getCardName());
        assertEquals(Card.Type.ACTION, cList.get(19).getType());
    ...
    {
        assertEquals(cList.get(0), Card.getCard(cList, Card.CardName.Gold));
        assertEquals(cList.get(1), Card.getCard(cList, Card.CardName.Silver));
        assertEquals(cList.get(2), Card.getCard(cList, Card.CardName.Copper));
        assertEquals(cList.get(3), Card.getCard(cList, Card.CardName.Province));
        assertEquals(cList.get(4), Card.getCard(cList, Card.CardName.Duchy));
        assertEquals(cList.get(5), Card.getCard(cList, Card.CardName.Estate));
        assertEquals(cList.get(6), Card.getCard(cList, Card.CardName.Curse));
        assertEquals(cList.get(7), Card.getCard(cList, Card.CardName.Adventurer));
        assertEquals(cList.get(8), Card.getCard(cList, Card.CardName.Ambassador));
        assertEquals(cList.get(9), Card.getCard(cList, Card.CardName.Baron));
        assertEquals(cList.get(10), Card.getCard(cList, Card.CardName.CouncilRoom));
        assertEquals(cList.get(11), Card.getCard(cList, Card.CardName.Cutpurse));
        assertEquals(cList.get(12), Card.getCard(cList, Card.CardName.Embargo));
        assertEquals(cList.get(13), Card.getCard(cList, Card.CardName.Feast));
        assertEquals(cList.get(14), Card.getCard(cList, Card.CardName.Gardends));
        assertEquals(cList.get(15), Card.getCard(cList, Card.CardName.GreatHall));
        assertEquals(cList.get(16), Card.getCard(cList, Card.CardName.Laboratory));
        assertEquals(cList.get(17), Card.getCard(cList, Card.CardName.Mine));
        assertEquals(cList.get(18), Card.getCard(cList, Card.CardName.Smithy));
        assertEquals(cList.get(19), Card.getCard(cList, Card.CardName.Village));
    }
