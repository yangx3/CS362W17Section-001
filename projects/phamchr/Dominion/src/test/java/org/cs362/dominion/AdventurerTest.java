...
//			
		      ...
		      player.deck.add(Card.getCard(cards, Card.CardName.Adventurer));
		     ...
		     //	play the game 
		      ...
		      assertEquals(state.players.get(0).discard.contains(Card.getCard(cards, Card.CardName.Copper)), false);
		      assertEquals(state.players.get(0).discard.contains(Card.getCard(cards, Card.CardName.Estate)), false);
