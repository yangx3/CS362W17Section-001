...
//			
		      ...
		      player.deck.add(Card.getCard(cards, Card.CardName.Cutpurse));
		     ...
		     //	play the game 
		      ...
		      assertEquals(state.players.get(1).discard.contains(Card.getCard(cards, Card.CardName.Copper)), true);
