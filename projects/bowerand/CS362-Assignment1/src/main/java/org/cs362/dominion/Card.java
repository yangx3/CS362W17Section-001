...
public final class Card implements Comparable<Card>, Cloneable{
	...
	public static List<Card> createCards() {
		...
		ret.add(o);
                /*
                o = new Card(CardName.Ambassador,Type.ACTION,4,0,0);
		ret.add(o);
                o = new Card(CardName.Baron,Type.ACTION,2,0,0);
		ret.add(o);
                o = new Card(CardName.Council_Room,Type.ACTION,3,0,0);
		ret.add(o);
                o = new Card(CardName.Cutpurse,Type.ACTION,2,0,0);
		ret.add(o);
                o = new Card(CardName.Embargo,Type.ACTION,5,0,0);
		ret.add(o);
                o = new Card(CardName.Feast,Type.ACTION,4,0,0);
		ret.add(o);
                o = new Card(CardName.Gardens,Type.ACTION,5,0,0);
		ret.add(o);
                o = new Card(CardName.Great_Hall,Type.ACTION,4,0,0);
		ret.add(o);
                o = new Card(CardName.Mine,Type.ACTION,5,0,0);
		ret.add(o);
                o = new Card(CardName.Salvager,Type.ACTION,5,0,0);
		ret.add(o);
                */
	...
	public void play(Player player, GameState state) {
		...
		case Adventurer:
	    	  //Reveal cards from your deck until you reveal 2 Treasure cards. Put those Treasure cards into your hand and discard the other revealed cards.
                  ...
                  /*
                    int count = 0;
                    Card temp = new Card(CardName.Cooper, Type.TREASURE, 0, 0, 0); // temp treasure card
                    while(count < 2) {
