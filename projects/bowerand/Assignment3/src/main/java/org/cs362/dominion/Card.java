		...
		case Adventurer:
	    	  /*Reveal cards from your deck until you reveal 2 Treasure cards. Put those Treasure cards into your hand and discard the other revealed cards.
                  ...
                  */
                    ...
                    while(count < 2) {
                        Card card =  player.checkCardType(temp); // Check for treasure, adds if found
                ...
                case Ambassador:
                    ...
                    if (nums == 0) { // add 0 or 1 of this card to supply
                        ...
                        while (ct < state.players.size()) {
                            if (ct != pPos) {
                                state.players.get(ct).hand.add(Card.getCard(state.cards, player.hand.get(pos1).getCardName())); // give everyone else this card
                            }
                        }
                ...
                case Baron:
                    ...
                    if (randOption == 0) {
                        ...
                        player.hand.add(Card.getCard(state.cards, Card.CardName.Estate));
                    }
                    player.discard(this); // discard this card
                    return;
                ...
                case Great_Hall:
                    player.discard(this);
                    player.hand.add(Card.getCard(state.cards, Card.CardName.Duchy));
                    player.drawCard();
                    player.numActions += 5;
                    return;
