...
public class PlayGame {
	...
	public static void main(String[] args) {
		...
		int turn = 0, players, cardnum, check, loopCtrl = 0, randomInt;
		...
		board.initialize();
        players = (rand.nextInt(4)+1);
		List<Player> numPlayers;
		...
		public static void CheckWin(Player player, Player player2){
			int victory1, victory2, numGarden = 0, numGarden2 = 0, deckSize = player.deck.size(), deckSize2 = player2.deck.size(), gVic;
			player.cleanUp();
			player2.cleanUp();
			System.out.print("\nThe game is over, checking players amount of Victory Cards!");
