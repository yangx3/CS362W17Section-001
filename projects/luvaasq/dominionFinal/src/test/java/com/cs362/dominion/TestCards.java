...
public class TestCards {
	...
	public void testEndTurn () throws Throwable {
		...
		assertEquals(0, state.players.get(0).coins);
		assertEquals(1, state.players.get(0).numBuys);
		assertEquals(1, state.players.get(0).numActions);
		assertEquals(3, state.players.get(0).discard.size());
		assertEquals(7, state.players.get(0).hand.size());
	}
	
	@Test
	public void testPlayTreasureCard () throws Throwable {
		state.players.get(0).playTtreasureCard();
		assertTrue((state.players.get(0).coins == 3) || (state.players.get(0).coins == 4));
	}
	
	@Test
	public void testScoreForGardens() throws Throwable {
		...
		state.players.get(0).hand.add(Card.getCard(cards, Card.CardName.Ambassador));
		state.players.get(0).hand.add(Card.getCard(cards, Card.CardName.Ambassador));
		assertEquals(5, state.players.get(0).scoreFor());
	}
	
	@Test
	public void testScoreFor() throws Throwable {
		assertEquals(4, state.players.get(0).scoreFor());
	}
	
	@Test
	public void testPlayerGain() throws Throwable {
		assertTrue(state.players.get(0).gain(Card.getCard(cards, Card.CardName.Adventurer)));
	}
	
	@Test
	public void testInitializePlayerTurn() throws Throwable {
		state.players.get(0).initializePlayerTurn();
		assertEquals(10, state.players.get(0).hand.size());
	}
	
	@Test
	public void testGetGameboardA() throws Throwable {
		state.gameBoard.put(Card.getCard(cards, Card.CardName.Adventurer), 0);
		assertEquals(null, state.getGameboard(Card.getCard(cards, Card.CardName.Adventurer)));
	}
	
	
	@Test
	public void testGetGameboardB() throws Throwable {
		state.gameBoard.put(Card.getCard(cards, Card.CardName.Adventurer), 1);
		assertEquals(Card.getCard(cards, Card.CardName.Adventurer), state.getGameboard(Card.getCard(cards, Card.CardName.Adventurer)));
	}

	
	@Test
	public void testIsGameOverA() throws Throwable {
		state.gameBoard.put(Card.getCard(cards, Card.CardName.Province), 0);
		assertTrue(state.isGameOver());
	}
	
	@Test
	public void testIsGameOverB() throws Throwable {
		assertFalse(state.isGameOver());
		state.gameBoard.put(Card.getCard(cards, Card.CardName.Adventurer), 0);
		state.gameBoard.put(Card.getCard(cards, Card.CardName.Baron), 0);
		state.gameBoard.put(Card.getCard(cards, Card.CardName.Mine), 0);
		assertTrue(state.isGameOver());
	}
