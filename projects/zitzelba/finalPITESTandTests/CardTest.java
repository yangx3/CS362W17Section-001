...
//			
		      ...
		      System.out.println("hand deck = " + state.players.get(0).deck.size());
		      System.out.println("hand coins = " + state.players.get(0).coins);
		      System.out.println("hand numActions = " + state.players.get(0).numActions + ", expected = " + 3);
		      System.out.println("hand numBuys = " + state.players.get(0).numBuys);
		      System.out.println("hand discard = " + state.players.get(0).discard.size());
		      assertEquals(state.players.get(0).hand.size(), after);
		      assertEquals(state.players.get(0).numActions, 3);
	   }
...
//			
		      ...
		      System.out.println("hand numActions = " + state.players.get(0).numActions);
		      System.out.println("hand numBuys = " + state.players.get(0).numBuys + ", expected= " + 2);
		      System.out.println("hand discard = " + state.players.get(0).discard.size());
		      assertEquals(state.players.get(0).hand.size(), after);
...
//			
		      ...
		      System.out.println("hand deck = " + state.players.get(0).deck.size());
		      System.out.println("hand coins = " + state.players.get(0).coins);
		      System.out.println("hand numActions = " + state.players.get(0).numActions + ", expected = " + 2);
		      System.out.println("hand numBuys = " + state.players.get(0).numBuys);
		      System.out.println("hand discard = " + state.players.get(0).discard.size());
		      assertEquals(state.players.get(0).hand.size(), after);
		      assertEquals(state.players.get(0).numActions, 2);
	   }
...
//	  				player.discard(state.players.get(0).hand.get(0));
//	  			}
		      //player.discard(Card.getCard(cards, Card.CardName.Cooper));
		      ...
		      System.out.println("hand hand = " + state.players.get(0).hand.size());
		      System.out.println("hand discard = " + state.players.get(0).discard.size());
		      int discardSize = state.players.get(0).discard.size() + 1;
		      ...
		      System.out.println("hand numActions = " + state.players.get(0).numActions);
		      System.out.println("hand numBuys = " + state.players.get(0).numBuys);
		      System.out.println("hand discard = " + state.players.get(0).discard.size() + ", expected = " + discardSize);
		      assertEquals(state.players.get(0).hand.size(), after);
		      //assertEquals(state.players.get(0).discard.size(), discardSize);
	   }
