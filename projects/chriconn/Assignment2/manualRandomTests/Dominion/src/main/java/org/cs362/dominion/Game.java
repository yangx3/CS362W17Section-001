...
public class Game {
    ...
    public String randomKingdomCard() {
        Random rand = new Random(10);
        String tempCard;
        do {
            tempCard = randomCard();
        } while (tempCard.equals("gold")     ||
                 tempCard.equals("silver")   ||
                 tempCard.equals("copper")   ||
                 tempCard.equals("estate")   ||
                 tempCard.equals("province") ||
                 tempCard.equals("dutchy") );
        return tempCard;
    }
    ...
    public void addToBank(String name) {
        bank.add(new Deck(10, new Card(name)));
    }
}
