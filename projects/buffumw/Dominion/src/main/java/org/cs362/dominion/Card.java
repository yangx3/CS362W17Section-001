...
public final class Card {
	...
	public enum Name {
		...
		Ambassador("Reveal a card from your hand. Return up to 2 copies of it "
				+ "from your hand to the Supply. Each other player gains a copy of it."), 
		...
		Embargo("+2 Coins | Trash this card, put Embargo token on a Supply pile. "
				+ "When buying card, player gains 1 curse card per embargo token on pile"), 
