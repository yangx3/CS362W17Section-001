...
public class GameState implements Cloneable{
	   ...
	   public void addPlayer(Player player) {       
			   players.add(player);    }
 /*    initializing all supplies, and shuffling deck and drawing starting hands for all players.
* Check that 10 cards selected are in fact (different) kingdom cards, and that numPlayers is valid.*/      
	  ...
	  /* public boolean addCard(Card c){
	   ...
	   int turn =0;       
	    ...
	    //checks for ending game conditions
