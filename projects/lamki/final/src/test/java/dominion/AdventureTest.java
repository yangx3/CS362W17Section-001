...
/*
    @Test
    public void test_cellar_no_play()
    {
        Game game = init(6);
        Random rand = ThreadLocalRandom.current();
        game.player[0].action_turns = 1;
        int play_c = 0;
        assertFalse(game.player_play(0, play_c, rand, game));
    }
    */
    @Test
    public void test_cellar_0()
    {
        Game game = init(6);
        Random rand = ThreadLocalRandom.current();
        game.player[0].action_turns = 1;
        int play_c = 0;
       	game.player[0].hand = Player.append(game.player[0].hand, new Adventure(6));
        assertTrue(game.player_play(0, play_c, rand, game));
    }

    @Test
    public void test_cellar_1()
    {
        Game game = init(6);
        Random rand = ThreadLocalRandom.current();
        game.player[0].action_turns = 1;
        int play_c = 0;
       	game.player[0].hand = Player.append(game.player[0].hand, new Adventure(6));
        assertTrue(game.player[0].action_turns == 1);
    }

    @Test
    public void test_cellar_2()
    {
        Game game = init(6);
        Random rand = ThreadLocalRandom.current();
        game.player[0].action_turns = 1;
    ...
    @Test
    public void test_chapel_0()
    {
        Game game = init(7);
        Random rand = ThreadLocalRandom.current();
        game.player[0].action_turns = 1;
        int play_c = game.randInt(rand, 0);
        game.player[0].hand = Player.append(game.player[0].hand, new Adventure(7));
        assertTrue(game.player_play(0, play_c, rand, game)); 
    }

    @Test
    public void test_chapel_1()
    {
        Game game = init(7);
        Random rand = ThreadLocalRandom.current();
        game.player[0].action_turns = 1;
    ...
    public void test_village()
    {
        ...
        assertTrue(game.player_play(0, play_c, rand, game)); 
        assertTrue(game.player[0].buy_turns != 0);
        assertTrue(game.player[0].action_turns == 2);
    ...
    public void test_witch()
    {
        ...
        assertTrue(game.player_play(0, play_c, rand, game)); 
        assertTrue(game.player[0].hand.length >= 2);
        assertTrue(game.player[0].deck[game.player[0].deck.length - 1].name != "Curse");
        assertTrue(game.player[1].deck[game.player[1].deck.length - 1].name == "Curse");
