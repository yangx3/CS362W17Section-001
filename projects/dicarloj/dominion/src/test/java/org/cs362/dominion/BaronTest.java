...
//			
		      ...
		      System.out.println("hand count = " + state.players.get(0).hand.size() + ", expected = "+ ( testState.players.get(0).hand.size() + newCards -2 ) );
		      System.out.println("deck count = " + state.players.get(0).deck.size() + ", expected = "+ ( testState.players.get(0).deck.size() - newCards ) );
		      System.out.println("discard = " + state.players.get(0).discard.size() + ", expected = "+ ( testState.players.get(0).discard.size() + 2 ) );
		      ...
		      System.out.println("coins = " + state.players.get(0).coins + ", expected = "+ ( testState.players.get(0).coins +4  ) );
		      ...
		      assertEquals(state.players.get(0).hand.size(),( testState.players.get(0).hand.size() + newCards -2 ))      ;
		      assertEquals(state.players.get(0).deck.size(),( testState.players.get(0).deck.size() - newCards ))      ;
		      assertEquals(state.players.get(0).discard.size(),( testState.players.get(0).discard.size() +2 ))      ;
		      assertEquals(state.players.get(0).numBuys,( testState.players.get(0).numBuys - newCards + 1))     ;
