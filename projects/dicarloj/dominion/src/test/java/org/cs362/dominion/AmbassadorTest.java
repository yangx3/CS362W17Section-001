...
//			
		      ...
		      System.out.println("hand count = " + state.players.get(0).hand.size() + ", expected = "+ ( testState.players.get(0).hand.size() + newCards -3 ) );
		      ...
		      System.out.println("discard = " + state.players.get(1).discard.size() + ", expected = "+ ( testState.players.get(1).discard.size() +1 ) );
		      System.out.println("numActions = " + state.players.get(1).numActions + ", expected = "+ ( testState.players.get(1).numActions  ) );
		      assertEquals(state.players.get(0).hand.size(),( testState.players.get(0).hand.size() + newCards -3))      ;
		      ...
		      assertEquals(state.players.get(1).discard.size(),( testState.players.get(1).discard.size() +1 ))      ;
