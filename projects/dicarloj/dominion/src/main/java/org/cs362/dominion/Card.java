...
//
	...
	public void play(Player player, GameState state) {
		...
		case Ambassador:
			System.out.println("\n[Ambassador]");
			System.out.println(player.player_username);
			if (player.hand.size()-player.playedCards.size()>0){
				Card c = null;
		...
		case Feast:
			...
			Card f = this.getCard(player.hand, Card.CardName.Feast);
			System.out.println("Trashes "+ f);
			player.hand.remove(f);
			
			List<Card> posible = new ArrayList<Card>(state.cards);
...
//	    	System.out.println("The player gets +1 play Action.");
		...
		case Remodle:
			...
			List<Card> pos = new ArrayList<Card>(state.cards);
