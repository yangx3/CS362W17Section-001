...
public class GameState implements Cloneable{
	   ...
	   public Map<Card, Integer> embargod = new HashMap<Card, Integer>();
	   public List<Card> cards ;
	   public List<Card> useingCards;
	   ...
	   public void initializeGame(){		
		    ...
		    //set number of Treasure cards
		      ...
		      useingCards = new ArrayList<Card>(cards);
		      for (Card c : cards){
		    	  if (!gameBoard.containsKey(c))
		    		  useingCards.remove(c);  		    	  
		      }
