...
//		player MyPlayer5 = new player("P5");
//		board b5 = new board();
//		MyPlayer.getHand().addElement(b5.get_great_hall().getdc());
//		MyPlayer.getActioncards().addElement((action_card)b5.get_great_hall().getdc());
//		MyPlayer.action(MyPlayer5, b5);
		...
		p1.getHand().addElement(b1.get_adventurer().getdc());//add to hand
		p1.getActioncards().addElement((action_card)b1.get_adventurer().getdc());
		
		p1.getHand().addElement(b1.get_council_room().getdc());//add to hand
		p1.getActioncards().addElement((action_card)b1.get_council_room().getdc());
		
		p1.getHand().addElement(b1.get_cutpurse().getdc());//add to hand
		p1.getActioncards().addElement((action_card)b1.get_cutpurse().getdc());
		
		p1.getHand().addElement(b1.get_baron().getdc());//add to hand
		p1.getActioncards().addElement((action_card)b1.get_baron().getdc());
		
		p1.getHand().addElement(b1.get_gold().getdc());//add to hand
		p1.getHand().addElement(b1.get_gold().getdc());//add to hand
		p1.getHand().addElement(b1.get_gold().getdc());//add to hand
		
		p1.getHand().addElement(b1.get_silver().getdc());//add to hand
		p1.getHand().addElement(b1.get_silver().getdc());//add to hand
		p1.getHand().addElement(b1.get_silver().getdc());//add to hand
		
		p1.getHand().addElement(b1.get_province().getdc());//add to hand
		p1.getHand().addElement(b1.get_province().getdc());//add to hand
		p1.getHand().addElement(b1.get_province().getdc());//add to hand
		
		p1.getHand().addElement(b1.get_duchy().getdc());//add to hand
		p1.getHand().addElement(b1.get_duchy().getdc());//add to hand
		p1.getHand().addElement(b1.get_estate().getdc());//add to hand
		
		p1.getHand().addElement(b1.get_curse().getdc());//add to hand
		
		p1.getHand().addElement(b1.get_adventurer().getdc());//add to hand
		p1.getActioncards().addElement((action_card)b1.get_adventurer().getdc());
		
		p1.getHand().addElement(b1.get_great_hall().getdc());//add to hand
		p1.getActioncards().addElement((action_card)b1.get_great_hall().getdc());
		
		p1.getHand().addElement(b1.get_great_hall().getdc());//add to hand
		p1.getActioncards().addElement((action_card)b1.get_great_hall().getdc());
		
		p1.getHand().addElement(b1.get_smithy().getdc());//add to hand
		p1.getActioncards().addElement((action_card)b1.get_smithy().getdc());
		
		
		p1.getHand().addElement(b1.get_steward().getdc());//add to hand
		p1.getActioncards().addElement((action_card)b1.get_steward().getdc());
		
		p1.getHand().addElement(b1.get_smithy().getdc());//add to hand
		p1.getActioncards().addElement((action_card)b1.get_steward().getdc());
		
		p1.getHand().addElement(b1.get_village().getdc());//add to hand
		p1.getActioncards().addElement((action_card)b1.get_village().getdc());
		
		p1.getHand().addElement(b1.get_tribute().getdc());//add to hand
		p1.getActioncards().addElement((action_card)b1.get_tribute().getdc());
		
		p1.getHand().addElement(b1.get_feast().getdc());//add to hand
		p1.getActioncards().addElement((action_card)b1.get_feast().getdc());
		
		p1.getHand().addElement(b1.get_minion().getdc());//add to hand
		p1.getActioncards().addElement((action_card)b1.get_minion().getdc());
		
		p1.getHand().addElement(b1.get_mine().getdc());//add to hand
		p1.getActioncards().addElement((action_card)b1.get_mine().getdc());
		
		p1.getHand().addElement(b1.get_ambassador().getdc());//add to hand
		p1.getActioncards().addElement((action_card)b1.get_ambassador().getdc());
