...
public class GameState{
	...
	public boolean isGameOver(){
		...
		else if(gameBoard.get(Card.getCard(cards, Card.CardName.Dutchy))==0)
		{
			return true;
		}
		else if(gameBoard.get(Card.getCard(cards, Card.CardName.Estate))==0)
		{
			return true;
		}
		else if(gameBoard.get(Card.getCard(cards, Card.CardName.Gold))==0)
		{
			return true;
		}
		else if(gameBoard.get(Card.getCard(cards, Card.CardName.Silver))==0)
		{
			return true;
		}
		else if(gameBoard.get(Card.getCard(cards, Card.CardName.Copper))==0)
		{
			return true;
		}
