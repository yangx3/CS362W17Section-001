...
public final class Card implements Comparable<Card>, Cloneable{
	...
	public static enum CardName {
		...
		Ambassador, Baron, CouncilRoom,
		Cutpurse, Embargo, Feast, Gardens,
		GreatHall, Mine, Steward;
	}
	/**
	...
	public void play(Player player, GameState state) {
		...
		case Embargo:
			...
			//token???????? I guess this could be a bug :D
		...
		case Gardens://1 Victory point for every 10 cards
			//figure out how to change victory points
		...
		case Steward:
			player.coins += 2; //Bug: Only allows player to receive 2 golds
							//Can't receive 2 cards or trash 2 cards
