...
//                System.out.println("#" + n);
            ...
            List<Card.CardName> options = new ArrayList<Card.CardName>();
    ...
    private List<Supply_Stack> sortByCost() {
        List<Supply_Stack> allSupply = new ArrayList<Supply_Stack>();
        ...
        List<Supply_Stack> toRemove = new ArrayList<Supply_Stack>();
        ...
        Collections.sort(allSupply, new Comparator<Supply_Stack>(){
            public int compare(Supply_Stack s1, Supply_Stack s2) {
...
//         putInHand(new Card(c.name));
    ...
    List<Card> cloneDeck(){
        List<Card> cloned = new ArrayList<Card>();
        for (Card c : deck)
